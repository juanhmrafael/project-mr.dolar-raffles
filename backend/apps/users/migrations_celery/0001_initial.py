# Generated by Django 5.2.4 on 2025-07-11 17:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(default='PENDING', help_text='Current state of the task being run', max_length=50, verbose_name='Task State')),
                ...
                ('date_started', models.DateTimeField(default=None, help_text='Datetime field when the task was started in UTC', null=True, verbose_name='Started DateTime')),
